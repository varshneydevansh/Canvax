...
- Turns a generated output preview card into an editable `Output edit` frame, so a result can become a normal sketch/correction branch instead of staying a passive reference.
