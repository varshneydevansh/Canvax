...
- Provides a primary Workbench `Add image` control for placing references, generated candidates, book/storyboard art, or UI assets as editable canvas elements without switching to Advanced mode.
