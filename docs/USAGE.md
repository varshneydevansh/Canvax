...
`get_output_binding`. It is not yet a native first-party Codex/ChatGPT bridge.
...
For Canvax-generated implementation bundles, you can prove the next step
locally with:
...
deterministic no-API proof path for generated bundles. It is not a replacement
for Codex editing arbitrary production app files.
