...
Verified locally on May 17, 2026 after the Map Prompt / Context inspector pass:
...
pixel widths, plus the Map viewport/tidy, lane-order, and object prompt/context
assertions.
