...
- higher-fidelity production UI generation beyond deterministic local
  scaffolds
- richer Open Design-style reusable skill/design-system discovery/search for
  larger kit libraries without turning Workbench into a prompt-only artifact
  generator
