...
- real-project evidence beyond the local production-like fixture that
  ...
  arbitrary app files
- live browser visual critique beyond static HTML/JSX semantic extraction,
  static artifact review, and local screenshot palette sampling
