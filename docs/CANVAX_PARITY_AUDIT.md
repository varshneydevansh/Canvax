...
- a first-class read-only Canvax tool/MCP bridge so Codex or ChatGPT can inspect
  the current frame, design kit, spatial workspace, and output bindings without
  copy/paste exports
