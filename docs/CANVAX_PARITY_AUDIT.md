...
- higher-fidelity production UI generation beyond deterministic local
  scaffolds
- richer Open Design-style reusable skill/design-system packaging, versioning,
  and team sharing for larger kit libraries without turning Workbench into a
