...
- real-project evidence beyond the local production-like fixture that
  ...
  arbitrary app files
- live DOM/motion/AI visual critique beyond static HTML/JSX semantic extraction,
  static artifact review, local screenshot palette sampling, local pixel-level
  screenshot review, and local design-jury aggregation
