...
- real-project evidence beyond the local production-like fixture that
  ...
  arbitrary app files
- live DOM/motion/AI visual critique and a named design-jury review beyond
  static HTML/JSX semantic extraction, static artifact review, local screenshot
  palette sampling, and local pixel-level screenshot review
