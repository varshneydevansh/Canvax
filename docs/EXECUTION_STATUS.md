...
- [x] `npm run execute-patch` can now apply explicit Live Edit source-hinted component/CSS files and append hinted task notes without a project-link contract; regression covers that source-hinted patch path
