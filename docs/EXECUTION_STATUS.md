...
- [x] Build with Codex local executor consumes designer implementation context to theme the generated preview/starter bundle and expose a visible `Designer context` panel in the generated surface
