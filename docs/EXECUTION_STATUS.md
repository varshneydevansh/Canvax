...
- [x] Workbench `Map` supports background drag-pan, left/top edge expansion for cards and Map objects, trailing workspace room, cursor-centered pinch/ctrl-wheel zoom, and `Fit map` recovery for visible frames/objects
