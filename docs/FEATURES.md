...
- adds a floating `Add to canvas` dock inside the spatial Map for one-click frame, note, file/reference, group, variant, generated-screen, and Codex build actions, making the Map feel like the primary workbench rather than a read-only flow view
