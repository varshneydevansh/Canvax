...
- true infinite spatial canvas beyond the Workbench Map frame/variant/context/generated-output object layer, especially nested groups and richer object editing. Generated output objects are now reconciled and legacy stale cards are cleaned up to reduce materialized-output clutter, but full history lanes remain open.
