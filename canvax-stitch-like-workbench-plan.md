...
- The left rail now has a browser-local project picker with `New`, `Duplicate`, `Delete`, and `Open project`. This gives Canvax a first Stitch-like project-switching layer while keeping the active project as the single live Codex handoff.
