...
- **Validation**:
  ...
  - Board self-test verifies Workbench Map renders, zooms, selects/nudges/duplicates/deletes Map objects, moves group regions with contained cards/objects, and exports frames, group regions, group containment, manual notes, asset candidates, generated targets, artifacts, and changed-file spatial objects.
